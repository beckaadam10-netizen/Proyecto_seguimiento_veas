...
@section('title', 'Nuevo Tipo de Actuación')
@section('header', 'Parámetros / Nuevo Tipo de Actuación')

@section('content')
<div class="max-w-xl">
    <form method="POST" action="{{ route('parametros.tipos-actuacion.store') }}" class="space-y-6">
        @csrf
