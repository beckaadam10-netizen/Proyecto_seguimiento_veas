...
@section('title', 'Editar Tipo de Actuación')
@section('header', 'Parámetros / Editar Tipo de Actuación')

@section('content')
<div class="max-w-xl">
    <form method="POST" action="{{ route('parametros.tipos-actuacion.update', $tipo) }}" class="space-y-6">
        @csrf @method('PUT')
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('parametros.index', ['abrir' => 'actuacion']) }}" class="text-gray-600 hover:text-gray-800 px-4 py-2 rounded-lg border hover:bg-gray-50">
                Cancelar
            </a>
        </div>
    </form>
