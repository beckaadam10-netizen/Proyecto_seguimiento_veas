...
@section('title', 'Nueva Institución Pública')
@section('header', 'Parámetros / Nueva Institución Pública')

@section('content')
<div class="max-w-xl">
    <form method="POST" action="{{ route('parametros.instituciones-publicas.store') }}" class="space-y-6">
        @csrf
