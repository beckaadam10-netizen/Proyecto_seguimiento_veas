...
@section('title', 'Nuevo Tipo de Gasto')
@section('header', 'Parámetros / Nuevo Tipo de Gasto')

@section('content')
<div class="max-w-xl">
    <form method="POST" action="{{ route('parametros.tipos-gasto.store') }}" class="space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 space-y-4">
            <div>
                ...
                <input type="text" name="nombre" value="{{ old('nombre') }}" required
                       placeholder="Ej: Fotocopia legalizada"
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('parametros.index', ['abrir' => 'gasto']) }}" class="text-gray-600 hover:text-gray-800 px-4 py-2 rounded-lg border hover:bg-gray-50">
                Cancelar
            </a>
        </div>
    </form>
