...
@section('header', 'Parámetros / Tipos de Documento')

@section('header-actions')
    <a href="{{ route('parametros.tipos-documento.create') }}"
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-4 py-3 text-right">
                    <a href="{{ route('parametros.tipos-documento.edit', $tipo) }}" class="text-gray-500 hover:text-brand-700 mr-3">
                        <i class="fas fa-edit"></i>
                    </a>
                    <form method="POST" action="{{ route('parametros.tipos-documento.destroy', $tipo) }}" class="inline"
