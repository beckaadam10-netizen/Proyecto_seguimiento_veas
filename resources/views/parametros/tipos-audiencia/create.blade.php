...
@section('title', 'Nuevo Tipo de Audiencia')
@section('header', 'Parámetros / Nuevo Tipo de Audiencia')

@section('content')
<div class="max-w-xl">
    <form method="POST" action="{{ route('parametros.tipos-audiencia.store') }}" class="space-y-6">
        @csrf
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('parametros.index', ['abrir' => 'audiencia']) }}" class="text-gray-600 hover:text-gray-800 px-4 py-2 rounded-lg border hover:bg-gray-50">
                Cancelar
            </a>
        </div>
    </form>
