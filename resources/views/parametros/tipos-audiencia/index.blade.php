...
@section('header', 'Parámetros / Tipos de Audiencia')

@section('header-actions')
    <a href="{{ route('parametros.tipos-audiencia.create') }}"
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-4 py-3 text-right">
                    <a href="{{ route('parametros.tipos-audiencia.edit', $tipo) }}" class="text-gray-500 hover:text-brand-700 mr-3">
                        <i class="fas fa-edit"></i>
                    </a>
                    <form method="POST" action="{{ route('parametros.tipos-audiencia.destroy', $tipo) }}" class="inline"
                          onsubmit="return confirm('¿Eliminar este tipo de audiencia?')">
                        @csrf @method('DELETE')
            ...
            <tr>
                <td colspan="4" class="px-4 py-10 text-center text-gray-400">
                    ...
                    <p>No hay tipos de audiencia registrados.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
