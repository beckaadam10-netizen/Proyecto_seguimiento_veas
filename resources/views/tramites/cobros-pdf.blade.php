...
<head>
    <meta charset="utf-8">
    <title>Comprobante de cobros - {{ $tramite->codigo }}</title>
    <style>
...
<div class="pagina">
    ...
    <table class="datos-doc">
        <tr><td><strong>Código:</strong> {{ $tramite->codigo }}</td></tr>
        <tr><td><strong>Cliente:</strong> {{ $tramite->cliente->nombre_completo }}</td></tr>
        <tr><td><strong>Trámite:</strong> {{ $tramite->nombre }}</td></tr>
        @if($tramite->institucionPublica)
        <tr><td><strong>Institución:</strong> {{ $tramite->institucionPublica->nombre }}</td></tr>
        @endif
    </table>
