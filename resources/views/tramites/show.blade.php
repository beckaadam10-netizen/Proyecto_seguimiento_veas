                ...
                <div class="px-5 py-3">
                    <div class="flex items-center justify-between gap-3 mb-1.5">
                        ...
                        <div class="flex items-center gap-3 flex-shrink-0">
                            ...
                            @endif
                            <button type="button" onclick="document.getElementById('cobro-detalle-{{ $tramite->id }}-{{ $loteId }}').classList.toggle('hidden'); this.querySelector('i').classList.toggle('fa-rotate-180')"
                                    class="text-gray-400 hover:text-gray-600" title="Ver ítems de este cobro">
                                <i class="fas fa-chevron-down text-xs transition-transform"></i>
                            </button>
                        </div>
                    </div>
                    <div id="cobro-detalle-{{ $tramite->id }}-{{ $loteId }}" class="hidden space-y-1 mt-2 pt-2 border-t border-gray-100">
